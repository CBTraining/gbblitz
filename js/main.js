...
import { VideoGalleryApp } from './components/video-gallery.js?v=5.10.0';
import { StarrySkyBackground } from './components/starry-sky.js?v=5.10.0';
import { ScrollLogoManager } from './components/scroll-logo.js?v=5.10.0';
import { MagicPointerManager } from './components/magic-pointer.js?v=5.10.0';
