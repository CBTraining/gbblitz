...
import { VideoGalleryApp } from './components/video-gallery.js?v=5.38.0';
import { StarrySkyBackground } from './components/starry-sky.js?v=5.38.0';
import { ScrollLogoManager } from './components/scroll-logo.js?v=5.38.0';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!window.matchMedia('(pointer: coarse)').matches && window.innerWidth > 768) {
    import('./components/magic-pointer.js?v=5.38.0').then(({ MagicPointerManager }) => {
